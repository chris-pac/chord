...
#   get.py
#
#   Command-Line Arguments: ip port key
#
#   python repy.py restrictions.test get.py ip port key
#
#   Chord Legend:
#       SHA-1               Ln 29
#       Chord Node          Ln 355
...
if callfunc == 'initialize':
    ...
    if len(callargs) != 3:
        print 'Please enter: ip port key'
    else:
        remoteip = callargs[0]
        ...
        if n0 is not None:
            print 'Get value from node', n0.id, n0.ip, n0.port
            val = n0.get(myid)
            print '************************************************'
            if val[0]:
                print 'The value of the key', myid, 'is:', val[1]
            else:
                print 'Unable to find val for key. Error:', val[1], myid
            print '************************************************'
        else:
            print 'Unable to find val for key.'
